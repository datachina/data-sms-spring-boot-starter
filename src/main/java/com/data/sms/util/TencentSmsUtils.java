...
public class TencentSmsUtils {
     ...
     * @param templateCode  短信模板ID,例如: 4****
    ...
    public SendSmsResponse sendSms(String phoneNumber, String signName, String templateCode, String templateParam) throws Exception {
        ...
        // 生成请求,国内短信senderId填""
        SendSmsRequest req = generateSendSmsRequest(phoneNumberSet, signName, "", templateCode, templateParam);
        // 发送短信
     ...
     * @throws Exception 异常
     */
    public void sendSms(String phoneNumber, String signName, String templateCode, String templateParam, SendTencentSmsListener listener) throws Exception {
        // 处理号码
        phoneNumber = "+86" + phoneNumber;
        String[] phoneNumberSet = {phoneNumber};
        // 生成请求,国内短信senderId填""
     ...
     * @throws Exception 异常
     */
    public SendSmsResponse sendInternationalSms(String phoneNumber, String signName, String senderId, String templateCode, String templateParam) throws Exception {
        // 处理号码
        String[] phoneNumberSet = {phoneNumber};
        // 生成请求
        SendSmsRequest req = generateSendSmsRequest(phoneNumberSet, signName, senderId, templateCode, templateParam);
        // 发送短信
        return tencentSmsClient.SendSms(req);
    }
     ...
     * @throws Exception 异常
     */
    public void sendInternationalSms(String phoneNumber, String signName, String senderId, String templateCode, String templateParam, SendTencentSmsListener listener) throws Exception {
        // 处理号码
        String[] phoneNumberSet = {phoneNumber};
        // 生成请求
        SendSmsRequest req = generateSendSmsRequest(phoneNumberSet, signName, senderId, templateCode, templateParam);
     ...
     * @return 请求
     */
    private SendSmsRequest generateSendSmsRequest(String[] phoneNumberSet, String signName, String senderId, String templateCode, String templateParam) {
        // 实例化一个请求对象
